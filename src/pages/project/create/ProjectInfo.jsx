...
const ProjectInfo = () => {
  ...
  const { onSubmit, memberSelectedList } = projectContext;
    ...
    <Fragment>
      ...
      {modalMember && (
        <ModalComponent modal={modalMember} toggle={toggleModalMember}>
          <ProjectMember memberList={projectContext.memberList} memberSelectedList={projectContext.memberSelectedList} />
        </ModalComponent>
      )}
    </Fragment>
  );
