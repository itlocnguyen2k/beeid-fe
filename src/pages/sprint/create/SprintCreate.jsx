...
const SprintCreate = () => {
  ...
  const { onSubmit, memberSelectedList, labelSelectedList, categorySelectedList, prioritySelectedList, dispatch } = sprintContext;
  ...
  return (
    <Fragment>
      <Breadcrumbs breadCrumbTitle="Thêm mới giai đoạn" breadCrumbParent="Giai đoạn" breadCrumbActive="Thêm mới giai đoạn">
        <BackButton />
      </Breadcrumbs>
                ...
                <Row>
                  <Col span="12">
                    <div className="form-check form-switch">
                      <Input type="switch" className="form-check-input" />
                      <Controller
                        render={({ field }) => (
                          <Input {...field} type="switch" className="form-check-input cursor-pointer" defaultChecked={true} />
                        )}
                        name="flagTemplate"
                        control={control}
                      />
                      <Label className="form-label" for="flagTemplate">
                        Sử dụng hạng mục có sẵn :
                      </Label>
                    </div>
                  </Col>
                </Row>
