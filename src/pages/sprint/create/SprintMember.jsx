...
const SprintMember = () => {
  ...
  const { memberList, memberSelectedList, memberOrgList, dispatch } = sprintContext;
      ...
      <li className="list-group-item d-flex justify-content-between align-items-center border-0 py-50 px-0 cursor-pointer" key={member._id}>
        ...
        <div className="d-flex align-items-center cursor-pointer">
          <UserPlus
            size={17}
            className="mx-0"
            onClick={() => dispatch(onSelected(ON_SELECTED_MEMBER, member, memberSelectedList, memberOrgList))}
          />
        </div>
      </li>
    ));
