...
import { Command, File, Info, List } from "react-feather";
import { Fragment, useState } from "react";
import Breadcrumbs from "../../../components/breadcrumbs/Breadcrumbs";
import BackButton from "../../../components/link/BackButton";
import TaskInfo from "./TaskInfo";
import TaskHistoryContainer from "../history/TaskHistoryContainer";
import SubTaskListContainer from "../../subtask/list/SubTaskListContainer";
...
const TaskUpdate = () => {
  ...
  return (
    <Fragment>
      <Breadcrumbs breadCrumbTitle="Chỉnh sửa công việc" breadCrumbParent="Công việc" breadCrumbActive="Chỉnh sửa công việc">
        <BackButton />
      </Breadcrumbs>
          ...
          <Nav pills>
            ...
            <NavItem>
              <NavLink active={activeTab === "4"} onClick={() => toggle("4")}>
                <List size={14} />
                <span className="align-middle d-none d-sm-block">Danh sách công việc</span>
              </NavLink>
            </NavItem>
          </Nav>
        </Col>
